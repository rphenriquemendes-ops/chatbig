...
export const metadata: Metadata = {
  title: 'Sobre',
  description: 'Conheça a fotógrafa por trás da Lume Foto, serviços e cidades atendidas.'
};
  ...
  return (
    <section className="container-wide grid gap-10 pb-20 md:grid-cols-[1fr_1.2fr]">
      <div className="relative aspect-[4/5] overflow-hidden rounded-2xl">
        <Image src="/placeholder/p03.svg" alt="Fotógrafa" fill className="object-cover" sizes="(max-width: 768px) 100vw, 40vw" />
      </div>
      <div className="space-y-6">
        <h1 className="text-4xl font-semibold">Sobre</h1>
        <p className="text-foreground/75">
          Sou Helena Duarte, fotógrafa especializada em narrativas visuais com estética minimalista. Trabalho com direção leve,
        ...
        <div>
          ...
          <p className="mt-2 text-foreground/75">São Paulo, Campinas, Rio de Janeiro, Belo Horizonte e atendimento em todo Brasil sob consulta.</p>
        </div>
      </div>
    </section>
  );
